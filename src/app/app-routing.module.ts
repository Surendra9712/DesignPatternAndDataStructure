...
import { DataStructureModule } from './DataStructure/data-structure.module';
...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./22. Chain of Responsibility/chain-of-responsibility.module').then(m => m.ChainOfResponsibilityModule)
  },
  {
    path: 'interpreter',
    loadChildren: () => import('./23. Interpreter/interpreter.module').then(m => m.InterpreterModule)
  },
  {
    path: 'data-structure',
    loadChildren: () => import('./DataStructure/data-structure.module').then(m => m.DataStructureModule)
  }
];
